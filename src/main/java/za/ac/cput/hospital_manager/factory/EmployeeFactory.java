...
public class EmployeeFactory {
    ...
    public static Employee build(String employeeId, Role role, String name, String surname, String password){
        ...
        return new Employee.Builder().employeeId(employeeId).role(role).name(name).surname(surname).password(password).build();
